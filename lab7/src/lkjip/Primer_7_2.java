...
public class Primer_7_2 {
    public static void main(String[] args) {
        try{
            File folder=new File("C:\\Users\\Ученик.DESKTOP-9UTQSM7\\IdeaProjects\\lab7\\My");
            if (!folder.exists())
                folder.mkdir();
            File f1=new File("C:\\Users\\Ученик.DESKTOP-9UTQSM7\\IdeaProjects\\lab7\\My\\strokiRand.txt");
            f1.createNewFile();
